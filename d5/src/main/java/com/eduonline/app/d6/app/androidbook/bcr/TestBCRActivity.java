package com.eduonline.app.d6.app.androidbook.bcr;

import com.eduonline.app.d6.app.androidbook.bcr.R;
...
public class TestBCRActivity extends Activity 
{
    ...
    private void testSendBroadcast()
    {
    	...
    	Intent broadcastIntent = new Intent("com.eduonline.app.d6.app.androidbook.intents.testbc");
