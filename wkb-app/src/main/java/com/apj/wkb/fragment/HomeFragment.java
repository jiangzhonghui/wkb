...
import com.apj.wkb.task.ILoadData;
...
public class HomeFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<HomeCategory>>, ILoadData{
    ...
    @Override
    public void loadData(List<HomeCategory> homeCategories) {
        if(homeCategories!=null && homeCategories.size()>0){
            gllery_container.setVisibility(View.VISIBLE);
            recommend_loading.setVisibility(View.GONE);
            grid_view_for_you.setVisibility(View.VISIBLE);
