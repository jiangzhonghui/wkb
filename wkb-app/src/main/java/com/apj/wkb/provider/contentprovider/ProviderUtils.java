...
public class ProviderUtils{
    ...
    public void addCourseItem(CourserItem item) {
        ...
        cv.put(TodoTable.COLUMN_PIC_URL ,item.getPicUrl());
        ...
        cv.put(TodoTable.COLUMN_TYPE_NAME,item.getType_name());
    ...
    public List<CourserItem> showCourseItems(String type) {
        ...
        int col8 = c.getColumnIndex(TodoTable.COLUMN_PIC_URL);
        ...
        for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
            ...
            item.setType_name(c.getString(col13));
            items.add(item);
